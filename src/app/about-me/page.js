  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mt-6 gap-10">
          ...
          <div className="flex flex-col justify-between w-full lg:max-w-xl mt-6 lg:mt-8">
            ...
            <div className="mt-auto flex lg:justify-end">
              <button className="bg-black text-white text-lg md:text-2xl lg:text-3xl rounded-full px-8 md:px-10 lg:px-14 py-3 md:py-4 hover:bg-gray-800 transition" onClick={handleContactRedirect}>
                Let's Talk
              </button>
            </div>
          </div>
      ...
      <div className="px-6 md:px-16 mt-10">
        ...
        <div className="justify-center items-center align-middle flex flex-col mt-14 text-center px-4">
